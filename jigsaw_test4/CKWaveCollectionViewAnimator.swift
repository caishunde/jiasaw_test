...
class CKWaveCollectionViewAnimator: NSObject, UIViewControllerAnimatedTransitioning, UIViewControllerTransitioningDelegate
{
    ...
    internal let animationDuration: Double! = 0.4
...
//                    sourceCollectionViewController.collectionView!.backgroundColor = UIColor(patternImage: UIImage(named: "bg1.jpg")!)
//                    fromViewController.view.backgroundColor = UIColor(patternImage: UIImage(named: "bg1.jpg")!)
